    ...
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <form method="POST" action="{{ route('store_users') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">Thank you example
                    @if ($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="user_name" id="user_name" placeholder="Enter username" value="{{ old('user_name') }}">
                    </div>

                    <div class="form-group">
                        <label for="user_email">Email address</label>
                        <input type="email" class="form-control" name="email" id="user_email" placeholder="Enter email" value="{{ old('user_email') }}">
                    </div>
